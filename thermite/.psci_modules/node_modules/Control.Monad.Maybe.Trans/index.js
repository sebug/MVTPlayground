...
var liftPassMaybe = function (__dict_Monad_2) {
    return function (pass) {
        return mapMaybeT(function (m) {
            return pass(Prelude[">>="](__dict_Monad_2["__superclass_Prelude.Bind_1"]())(m)(function (_9) {
                return Prelude["return"](__dict_Monad_2)((function () {
                    ...
                    if (_9 instanceof Data_Maybe.Just) {
                        return new Data_Tuple.Tuple(new Data_Maybe.Just(_9.value0.value0), _9.value0.value1);
                    };
...
var liftListenMaybe = function (__dict_Monad_3) {
    return function (listen) {
        return mapMaybeT(function (m) {
            return Prelude[">>="](__dict_Monad_3["__superclass_Prelude.Bind_1"]())(listen(m))(function (_8) {
...
var bindMaybeT = function (__dict_Monad_5) {
    return new Prelude.Bind(function (x) {
        return function (f) {
            return MaybeT.create(Prelude[">>="](__dict_Monad_5["__superclass_Prelude.Bind_1"]())(runMaybeT(x))(function (_7) {
