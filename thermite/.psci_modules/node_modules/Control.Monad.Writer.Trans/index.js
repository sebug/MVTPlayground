...
var runWriterT = function (_227) {
    return _227;
};
var monadTransWriterT = function (__dict_Monoid_4) {
    return new Control_Monad_Trans.MonadTrans(function (__dict_Monad_5) {
        return function (m) {
            return WriterT.create(Prelude[">>="](__dict_Monad_5["__superclass_Prelude.Bind_1"]())(m)(function (_16) {
                return Prelude["return"](__dict_Monad_5)(new Data_Tuple.Tuple(_16, Data_Monoid.mempty(__dict_Monoid_4)));
            }));
        };
    });
};
...
var functorWriterT = function (__dict_Functor_9) {
    return new Prelude.Functor(function (f) {
        return mapWriterT(Prelude["<$>"](__dict_Functor_9)(function (_226) {
            return new Data_Tuple.Tuple(f(_226.value0), _226.value1);
        }));
    });
};
                ...
                return WriterT.create((function () {
                    var k = function (_228) {
                        return function (_229) {
                            return new Data_Tuple.Tuple(_228.value0(_229.value0), Prelude["<>"](__dict_Monoid_13["__superclass_Prelude.Semigroup_0"]())(_228.value1)(_229.value1));
                        };
                    };
...
var bindWriterT = function (__dict_Monoid_11) {
    return function (__dict_Monad_12) {
        return new Prelude.Bind(function (m) {
            return function (k) {
                return WriterT.create(Prelude[">>="](__dict_Monad_12["__superclass_Prelude.Bind_1"]())(runWriterT(m))(function (_15) {
                    return Prelude[">>="](__dict_Monad_12["__superclass_Prelude.Bind_1"]())(runWriterT(k(_15.value0)))(function (_14) {
                        return Prelude["return"](__dict_Monad_12)(new Data_Tuple.Tuple(_14.value0, Prelude["<>"](__dict_Monoid_11["__superclass_Prelude.Semigroup_0"]())(_15.value1)(_14.value1)));
                    });
                }));
            };
        }, function () {
