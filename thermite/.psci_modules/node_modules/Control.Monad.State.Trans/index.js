    ...
    return function (m) {
        return function (s) {
            return Prelude[">>="](__dict_Monad_2["__superclass_Prelude.Bind_1"]())(m)(function (_11) {
                return Prelude["return"](__dict_Monad_2)(new Data_Tuple.Tuple(_11, s));
            });
        };
    };
});
    ...
    return function (pass) {
        return function (m) {
            return StateT.create(function (s) {
                return pass(Prelude[">>="](__dict_Monad_5["__superclass_Prelude.Bind_1"]())(runStateT(m)(s))(function (_13) {
                    return Prelude["return"](__dict_Monad_5)(new Data_Tuple.Tuple(new Data_Tuple.Tuple(_13.value0.value0, _13.value1), _13.value0.value1));
                }));
            });
        };
    };
...
var liftListenState = function (__dict_Monad_6) {
    return function (listen) {
        return function (m) {
            return StateT.create(function (s) {
                return Prelude[">>="](__dict_Monad_6["__superclass_Prelude.Bind_1"]())(listen(runStateT(m)(s)))(function (_12) {
                    return Prelude["return"](__dict_Monad_6)(new Data_Tuple.Tuple(new Data_Tuple.Tuple(_12.value0.value0, _12.value1), _12.value0.value1));
                });
            });
        };
    };
...
var bindStateT = function (__dict_Monad_10) {
    return new Prelude.Bind(function (_224) {
        return function (_225) {
            return function (s) {
                return Prelude[">>="](__dict_Monad_10["__superclass_Prelude.Bind_1"]())(_224(s))(function (_10) {
                    return runStateT(_225(_10.value0))(_10.value1);
                });
            };
        };
    }, function () {
