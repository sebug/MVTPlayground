...
var runErrorT = function (_216) {
    return _216;
};
var monadTransErrorT = function (__dict_Error_2) {
    return new Control_Monad_Trans.MonadTrans(function (__dict_Monad_3) {
        return function (m) {
            return ErrorT.create(Prelude[">>="](__dict_Monad_3["__superclass_Prelude.Bind_1"]())(m)(function (_4) {
                return Prelude["return"](__dict_Monad_3)(new Data_Either.Right(_4));
            }));
        };
    });
};
...
var liftPassError = function (__dict_Monad_8) {
    return function (pass) {
        return mapErrorT(function (m) {
            return pass(Prelude[">>="](__dict_Monad_8["__superclass_Prelude.Bind_1"]())(m)(function (_6) {
                return Prelude["return"](__dict_Monad_8)((function () {
                    if (_6 instanceof Data_Either.Left) {
                        return new Data_Tuple.Tuple(new Data_Either.Left(_6.value0), Prelude.id(Prelude.categoryArr));
                    };
                    if (_6 instanceof Data_Either.Right) {
                        return new Data_Tuple.Tuple(new Data_Either.Right(_6.value0.value0), _6.value0.value1);
                    };
...
var liftListenError = function (__dict_Monad_9) {
    return function (listen) {
        return mapErrorT(function (m) {
            return Prelude[">>="](__dict_Monad_9["__superclass_Prelude.Bind_1"]())(listen(m))(function (_5) {
                return Prelude["return"](__dict_Monad_9)(Prelude["<$>"](Data_Either.functorEither)(function (r) {
                    return new Data_Tuple.Tuple(r, _5.value1);
                })(_5.value0));
            });
        });
    };
...
var applyErrorT = function (__dict_Apply_13) {
    return new Prelude.Apply(function (_217) {
        return function (_218) {
            return ErrorT.create(Prelude["<*>"](__dict_Apply_13)(Prelude["<$>"](__dict_Apply_13["__superclass_Prelude.Functor_0"]())(Control_Apply.lift2(Data_Either.applyEither)(Prelude["$"]))(_217))(_218));
        };
    }, function () {
...
var bindErrorT = function (__dict_Monad_11) {
    return function (__dict_Error_12) {
        return new Prelude.Bind(function (m) {
            return function (f) {
                return ErrorT.create(Prelude[">>="](__dict_Monad_11["__superclass_Prelude.Bind_1"]())(runErrorT(m))(function (_3) {
                    if (_3 instanceof Data_Either.Left) {
                        return Prelude["return"](__dict_Monad_11)(new Data_Either.Left(_3.value0));
                    };
                    if (_3 instanceof Data_Either.Right) {
                        return runErrorT(f(_3.value0));
                    };
                    throw new Error("Failed pattern match");
                }));
            };
