...
var monadErrorErrorT = function (__dict_Monad_0) {
    return function (__dict_Error_1) {
        return new MonadError(function (m) {
            return function (h) {
                return Control_Monad_Error_Trans.ErrorT.create(Prelude[">>="](__dict_Monad_0["__superclass_Prelude.Bind_1"]())(Control_Monad_Error_Trans.runErrorT(m))(function (_17) {
                    if (_17 instanceof Data_Either.Left) {
                        return Control_Monad_Error_Trans.runErrorT(h(_17.value0));
                    };
                    if (_17 instanceof Data_Either.Right) {
                        return Prelude["return"](__dict_Monad_0)(new Data_Either.Right(_17.value0));
                    };
...
var monadErrorError = function (__dict_Error_2) {
    return new MonadError(function (_230) {
        return function (_231) {
            if (_230 instanceof Data_Either.Left) {
                return _231(_230.value0);
            };
            if (_230 instanceof Data_Either.Right) {
                return new Data_Either.Right(_230.value0);
            };
            throw new Error("Failed pattern match");
        };
