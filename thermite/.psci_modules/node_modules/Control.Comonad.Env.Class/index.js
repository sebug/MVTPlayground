...
}, Data_Tuple.fst, function (_324) {
    return function (_325) {
        return new Data_Tuple.Tuple(_324(_325.value0), _325.value1);
    };
});
    ...
    return new ComonadEnv(function () {
        ...
        return function (x) {
            return Control_Comonad_Env_Trans.EnvT.create((function () {
                var _1016 = Control_Comonad_Env_Trans.runEnvT(x);
                return new Data_Tuple.Tuple(f(_1016.value0), _1016.value1);
            })());
        };
    });
};
