...
var monadErrorErrorT = function (__dict_Monad_0) {
    return function (__dict_Error_1) {
        return new MonadError(function (m) {
            return function (h) {
                return Control_Monad_Error_Trans.ErrorT.create(Prelude[">>="](__dict_Monad_0["__superclass_Prelude.Bind_1"]())(Control_Monad_Error_Trans.runErrorT(m))(function (_15) {
                    if (_15 instanceof Data_Either.Left) {
                        return Control_Monad_Error_Trans.runErrorT(h(_15.value0));
                    };
                    if (_15 instanceof Data_Either.Right) {
                        return Prelude["return"](__dict_Monad_0)(new Data_Either.Right(_15.value0));
                    };
                    throw new Error("Failed pattern match");
                }));
            };
        }, function (e) {
            return Control_Monad_Error_Trans.ErrorT.create(Prelude["return"](__dict_Monad_0)(new Data_Either.Left(e)));
        });
    };
};
var monadErrorError = function (__dict_Error_2) {
    return new MonadError(function (_160) {
        return function (_161) {
            if (_160 instanceof Data_Either.Left) {
                return _161(_160.value0);
            };
            if (_160 instanceof Data_Either.Right) {
                return new Data_Either.Right(_160.value0);
            };
            throw new Error("Failed pattern match");
        };
