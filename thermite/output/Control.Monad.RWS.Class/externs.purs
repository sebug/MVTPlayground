...
foreign import instance monadRWSErrorT :: (Prelude.Monad m, Data.Monoid.Monoid w, Control.Monad.RWS.Class.MonadRWS r w s m, Control.Monad.Reader.Class.MonadReader r m, Control.Monad.Writer.Class.MonadWriter w m, Control.Monad.State.Class.MonadState s m, Control.Monad.Error.Error e) => Control.Monad.RWS.Class.MonadRWS r w s (Control.Monad.Error.Trans.ErrorT e m)
